        ...
        <div className={styles.promptsContainer}>
            ...
            <nav className={styles.navbar}>
                ...
                <ul className={styles.navbarNav}>
                    <li><Link to="/home" className={styles.navLink}>Dashboard</Link></li> {/* Active state */}
                    <li><Link to="/Prompts" className={`${styles.navLink} ${styles.activeNavLink}`}>Prompts</Link></li>
